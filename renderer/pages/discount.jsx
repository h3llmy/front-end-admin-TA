...
export default function Discount() {
        ...
        const fetching = async () => {
            try {
                const [products] = await Promise.all([
                    fetchApi.get(`/discount/list?page=${currentPage}&limit=10${searchText && `&search=${searchText}`}`)
                ])
    ...
    const totalPages = discountList?.totalPages;
        ...
        <>
            <form className="flex items-center pb-6" onSubmit={handleSubmit}>
                ...
                <div className="relative w-full">
                    ...
                    <input type="text" id="search" name="search" className="shadow-md bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" />
                </div>
            ...
            <Table headers={columns} data={discountList?.list} actions={['detail', 'update', 'delete']} />
